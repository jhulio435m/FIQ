...
- Enviar alerta por webhook si se configura.
...
Editar `/etc/fiq-watcher/watcher.env` en el servidor con los dominios reales, `DASHBOARD_API_KEY` y webhook si aplica.
